      ...
      <figure className="flex flex-col md:mx-20">
        <section className="text-[var(--font-light)] grid grid-cols-1 md:grid-cols-2 mt-16 gap-4 mx-4">
          <div className="flex flex-col w-full rounded-xl p-4">
            <h1 className="flex flex-col justify-center align-middle font-extrabold text-4xl sm:text-5xl lg:text-7xl tracking-tight text-center bg-clip-text text-transparent bg-gradient-to-r from-[var(--gradient-start)] via-[var(--gradient-via)] to-[var(--gradient-end)]">
